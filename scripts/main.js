...
bDirections.onclick = function() {
  $( "#content" ).empty();
  var myDirections = $( "<p>Directions:</br>We are convenently located in the heart of the restaurant district, on the main road. Starting at Interstate 95, take exit 33B, drive 3 miles to Restaurant Row and you will see Restaurant L'Idiot on the right side.</p>" );
  $( "#content" ).hide();
...
bContact.onclick = function() {
  $( "#content" ).empty();
  var myContact = $( "<p>Contact Us:</br>Restaurant L'Idiot is not a real restaurant; rather this is an Odin Project assignment website which demonstrates dynamic html through Javascript and jQuery. The author of  this website, Nicholas Agro, can be contacted at (516)441-7820.</p>" );
  $( "#content" ).hide();
